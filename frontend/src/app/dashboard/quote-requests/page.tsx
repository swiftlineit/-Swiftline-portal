        ...
        <div className="mb-6 flex flex-wrap items-start justify-between gap-4">
          ...
          <div className="flex gap-2">
            ...
            <select
              ...
              className="h-10 border border-slate-300 bg-white px-3 pr-9 text-sm font-semibold text-slate-700"
            >
            ...
            <Link
              ...
              className="inline-flex h-10 items-center gap-2 bg-blue-950 px-4 text-sm font-semibold text-white"
            >
              <FiPlus />
              Create Quote
            </Link>
