...
import { FiArchive, FiBriefcase, FiClipboard, FiCreditCard, FiDollarSign, FiFileText, FiGrid, FiHelpCircle, FiLogOut, FiPackage, FiTruck, FiUser } from "react-icons/fi";
