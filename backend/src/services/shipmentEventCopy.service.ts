...
const eventNotes: Record<ShipmentEventStatus, string> = {
  ...
  ORIGIN_HUB_PROCESSED: "Shipment processed at the Swiftline origin hub.",
  READY_FOR_EXPORT: "Shipment prepared and ready for export.",
  ORIGIN_HUB_DISPATCHED: "Shipment dispatched from the Swiftline origin hub.",
